...
export default function EnhancedKhataBillingForm({ onSubmit, initialData }: EnhancedKhataBillingFormProps) {
  ...
  const calculateTotals = () => {
    ...
    // Calculate discount weight in monetary value using weighted average rate
    const avgRate = totalWeight > 0 ? subtotal / totalWeight : 0;
    const discountWeightMonetary = form.getValues('discountWeight') * avgRate;
    const discounts = form.getValues('discountAmount') + discountWeightMonetary;

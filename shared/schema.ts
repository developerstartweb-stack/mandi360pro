...
// Sub-fields schema for combined creation (without lotId)
export const insertLotEntrySubFieldsForCreationSchema = createInsertSchema(lotEntrySubFields).omit({
  id: true,
  lotId: true, // Exclude lotId as it will be generated by backend
  createdAt: true,
  updatedAt: true,
});
...
export const createLotWithSubFieldsSchema = z.object({
  ...
  subFields: z.array(insertLotEntrySubFieldsForCreationSchema),
});
...
export const companyProfile = pgTable('company_profile', {
  ...
  whatsappName: varchar('whatsapp_name', { length: 100 }),
